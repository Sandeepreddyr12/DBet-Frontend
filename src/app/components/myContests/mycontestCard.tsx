...
export default function mycontestCard({}: Props) {
  return (
    <div className="relative max-w-3xl p-2 min-w-max mx-3 my-4 bg-white border rounded-lg   dark:bg-gray-800 dark:border-gray-700 cursor-pointer">
