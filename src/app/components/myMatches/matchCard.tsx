...
export default function matchCard({
  ...
  return (
    <div
      ...
      className="relative w-full max-w-3xl p-2 min-w-max mx-5 my-6 border rounded-lg   bg-gray-800 border-gray-700 cursor-pointer shadow-lg hover:scale-110 transition delay-100 duration-150 ease-in-out"
    >
      ...
      <dl className="max-w-screen-xl mx-auto flex flex-row items-center justify-between text-gray-900 text-white">
        <div className="flex items-center justify-center w-40 h-20 bg-slate-500 rounded-full">
          <div className=" py-3 px-4">
            ...
            <dd className=" text-xs text-gray-200 font-semibold">{matchDetails?.teamA}</dd>
          </div>
        ...
        <div className=" py-3 px-6 flex flex-col items-center justify-center">
          <dt className="mb-2 text-grey-500  text-xs">
            {matchDetails?.status}
          </dt>
        ...
        <div className="flex items-center justify-center w-40 h-20 bg-slate-500 rounded-full">
          ...
          <div className=" py-3 px-4">
            ...
            <dd className=" text-xs text-gray-200 font-semibold">{matchDetails?.teamB}</dd>
          </div>
        </div>
      </dl>
    </div>
