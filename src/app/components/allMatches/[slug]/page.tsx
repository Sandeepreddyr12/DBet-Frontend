...
let HelperVar = false;
  ...
  return (
    <div className="w-screen h-screen m-auto flex justify-center items-center bg-yellow-50">
      <div className=" w-10/12  flex justify-between items-center  space-x-10 flex-wrap sm:flex-nowrap">
        <div className="product-img w-1/2 min-w-min h-[30rem] bg-green-100 flex">
          ...
          />  */}
            ...
            <div className="col-span-3 row-start-4">{team1_Winings}</div>
        ...
        <div className="relative product-detail w-1/2 space-y-10 justify-self-center">
          ...
          <div className=" w-72 flex flex-col flex-nowrap m-auto">
            ...
            <div className="w-full ">
              <button
                disabled={HelperVar}
                className=" text-white {{HelperVar ? bg-green-500 : bg-red-800 cursor-not-allowed tracking-wider }} font-bold   w-full px-7 py-2"
              >
                {HelperVar ? 'Closed' : 'Join Now'}
              </button>
            </div>
          </div>
        </div>
